...
const googleLoginButton = document.getElementById('googleLoginButton'); // Selektuje div za Google dugme
...
window.onload = function () {
    ...
    // Renderovanje Google dugmeta u div sa ID-jem "googleLoginButton"
    google.accounts.id.renderButton(
        document.getElementById("googleLoginButton"),
        { theme: "outline", size: "large", text: "signin_with" } // Dodao sam "text" opciju radi lepšeg izgleda
    );
